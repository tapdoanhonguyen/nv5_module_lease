	...
	<div class="pl-3">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb mb-0 p-0">
				...
				<li class="breadcrumb-item active" aria-current="page">{LANG.serviceextra}</li>
				<li class="breadcrumb-item " aria-current="page">{LANG.serviceextra_edit}</li>
			</ol>
		</nav>
	</div>
	<div class="ml-auto">
		<div class="btn-group">
			<a type="button" class="btn btn-primary" href="{serviceextra_add}"><i class="lni lni-add-files mrg-r-5"></i>{LANG.add}</a>
			...
			<div class="form-row">
				...
				<div class="col-md-4 mb-3">
					...
					<div class="form-group">
						...
						<input class="mask form-control" type="text" name="totalvnd" value="{ROW.totalvnd}" id="totalvnd" />
					</div>
				...
				<div class="col-md-4 mb-3">
					...
					<div class="form-group">
						...
						<input class="mask form-control" type="text" name="totalusd" value="{ROW.totalusd}" id="totalusd"/>
					</div>
				</div>
			</div>
			<div class="form-group">
