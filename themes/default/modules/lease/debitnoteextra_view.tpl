					...
					<table border="1" cellpadding="10" cellspacing="1" width="100%">
						...
						<tbody >
							...
							<tr>
								...
								<td>{ROW.datefrom}</td>
								<td>{ROW.dateto}</td>
								<td style="text-align:right">{DBN.price_vi}</td>
								<td style="text-align:right">{DBN.amount}</td>
								<td style="text-align:right">{DBN.total_vi}</td>
							</tr>
							<!-- END: service_vi -->
						</tbody>
						<tfoot>
							<tr>
								...
								<th style="text-align:right">{total_vi}</th>
							</tr>
				...
				<div class="table-responsive" style="margin-bottom: 20px">
					<table border="1" cellpadding="10" cellspacing="1" width="100%">
						...
						<tfoot>
							<tr>
								<th colspan="5" style="text-align:right">{LANG.total}</th>
								<th style="text-align:right">{total_en}</th>
							</tr>
						</tfoot>		
					</table>
				</div>
