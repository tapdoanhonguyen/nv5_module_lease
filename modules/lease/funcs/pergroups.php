...
if ($nv_Request->isset_request('delete_id', 'get') and $nv_Request->isset_request('delete_checkss', 'get')) {
    ...
    if ($id > 0 and $delete_checkss == md5($id . NV_CACHE_PREFIX . $client_info['session_id'])) {
        ...
        nv_insert_logs(NV_LANG_DATA, $module_name, 'Delete Pergroups', 'ID: ' . $id, $admin_info['userid']);
...
$xtpl = new XTemplate('pergroups.tpl', NV_ROOTDIR . '/themes/' . $module_info['template'] . '/modules/' . $module_file);
...
$page_title = $lang_module['pergroups'];
